document.addEventListener("DOMContentLoaded", function () {
    ...
    function confirmDelete(songId) {
        const confirmDelete = confirm("Är du säker på att du vill ta bort denna låt?");
        if (confirmDelete) {
            deleteSong(songId);
        }
    }
    ...
    function generateYouTubeEmbed(url) {
        ...
        return videoId ? `<iframe width="300" height="200" src="https://www.youtube.com/embed/${videoId}" frameborder="0" allowfullscreen></iframe>` : "";
    }
})
